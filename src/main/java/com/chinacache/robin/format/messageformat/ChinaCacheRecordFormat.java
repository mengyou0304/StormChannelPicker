 ...
 *
 */
public class ChinaCacheRecordFormat implements RecordFormat {
	 ...
	 * @return
	 */
	public ChinaCacheRecordFormat withFields(Fields fields) {
		this.fields = fields;
		return this;
	}
	 ...
	 * @return
	 */
	public ChinaCacheRecordFormat withFieldDelimiter(String delimiter) {
	 ...
	 * @return
	 */
	public ChinaCacheRecordFormat withRecordDelimiter(String delimiter) {
	...
	public byte[] format(Tuple tuple) {
		...
		if (tuple.getValueByField("logline") != null)
			sb.append(tuple.getValueByField("logline") + "\n");
