...
// */
//
//public class WindowCachedProducer {
//	private static final Logger logger = LoggerFactory
//		.getLogger(WindowCachedProducer.class);
//	private static Long nums = 0l;
//	private KafkaProducer<String, String> producer;
//	private Properties configurations;
//
//	private static WindowCachedProducer instance;
//
//	public static WindowCachedProducer getInstance(String innerKafkaBroker){
//		if(instance==null)
//			instance=new WindowCachedProducer(innerKafkaBroker);
//		return instance;
//	}
//
//	private WindowCachedProducer(String innerKafkaBroker) {
...
//		WindowCachedProducer cp = new WindowCachedProducer(AllConfiguration.KAFKA_INNER_BROKER);
//		cp.buildConnection();
